	...
	protected function register_controls() {
		...
		$this->add_control(
            ...
            [
                ...
                'raw' => '<div class="elementor-update-preview editor-wpr-preview-update"><span>Click the Publish Button, then Click the Apply Button</span><button class="elementor-button elementor-button-success" onclick="elementor.reloadPreview();">Apply</button>',
                'separator' => 'after'
            ]
		);
