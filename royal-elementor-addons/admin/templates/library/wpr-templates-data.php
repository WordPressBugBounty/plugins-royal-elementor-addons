...
class WPR_Templates_Data {
		...
		return [
			...
			'newyear' => [
				'v1' => [
					...
					'pages' => 'home,gallery,events,contact,',
					'plugins' => '{}',
					'tags' => 'free single page landing page one page onepage landingpage newyear christmas celebration event entertainment evening party new year',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => false,
			...
			'christmas' => [
				'v1' => [
					...
					'pages' => 'home,shop,product-details,cart,blog,blog-details,contact,',
					'plugins' => '{"woocommerce":'. $is_woo_active .'}',
					'tags' => 'free christmas newyear store shop woo woocommerce estore ecommerce product gifts holiday festive new year',
					'theme-builder' => true,
					'woo-builder' => true,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
			...
			'plumbing' => [
				'v1' => [
					...
					'plugins' => '{}',
					'tags' => 'free plumbing solutions repair pipe replacement water bathroom emergency technician professional support plumber electrician handyman solar maintenance contractor hvac',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => true,
					'price' => $is_pro_active ? 'free' : 'free',
			...
			'token' => [
				'v1' => [
					...
					'pages' => 'home,',
					'plugins' => '{}',
					'tags' => 'free ico single page landing one onepage landingpage crypto currency cryptocurrency fundrising bitcoin blockchain investor profit retail market purchase token money clinet transaction payment nft bitcoin blockchain investor profit retail market purchase token coin solana community reward',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
			...
			'graphic-nature' => [
				'v1' => [
					...
					'plugins' => '{}',
					'tags' => 'free nature influencer travel content slider tourism influencers creator travel forest slider generic multipurpose national-park nature-park sanctuary wilderness hitchhiking mountain river lakes outdoors graphic design illustration beginner travel easy',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
			...
			'online-course' => [
				...
				'v2' => [
					'name' => 'Online Courses V2',
					'pages' => 'home,about,courses,courses-v2,courses-with-filters,course-details,faq,blog,single-blog,contact,cart',
					'plugins' => '{"woocommerce":'. $is_woo_active .'}',
					'tags' => 'online course learning tutorials education coaching academy elearning udemy tutor lms training center lifter lms learnpress learndash instructor online lessons distance learning',
					'theme-builder' => true,
					'woo-builder' => true,
			...
			'life-coaching' => [
				'v1' => [
					'name' => 'Life Coaching V1',
					'pages' => 'home,about,shop,course-details,cart,podcast,podcast-details,events,blog,single-blog,contact,',
					'plugins' => '{"woocommerce":'. $is_woo_active .'}',
					'tags' => 'pro life coaching coach certification courses online course podcast students student lecturer teacher trainer training mind tutorials tutor life coach business coaching consulting healthy coaching wellness coach career counseling counseling mentor therapist therapy',
					'theme-builder' => true,
					'woo-builder' => true,
					'off-canvas' => true,
					'price' => $is_pro_active ? 'free' : 'pro',
			...
			'fast-food' => [
				'v1' => [
					...
					'pages' => 'home,menu,about,offers,franchise,contact,',
					'plugins' => '{"contact-form-7":'. $is_cf7_active .'}',
					'tags' => 'menu online market food delivery restaurant fast food restaurant pizzeria burger recipes cooking pizza restaurant snack landing page',
					'theme-builder' => false,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
			...
			'wooshop' => [
				...
				'v2' => [
					'name' => 'Woo Shop V2',
					'pages' => 'home,shop,single-product,cart,about,blog,single-blog,contact,',
					'plugins' => '{"woocommerce":'. $is_woo_active .'}',
			...
			'woo-auto-parts' => [
				...
				'v2' => [
					'name' => 'Auto Parts Store - Car V2',
					'pages' => 'home,shop,shop-v2,shop-list-view,single-product,cart,wishlist,compare,about,blog,single-blog,contact,',
					'plugins' => '{"woocommerce":'. $is_woo_active .'}',
					'tags' => 'auto parts store shop shopping woo-commerce woocommerce estore ecommerce product online eshopping market car parts automobile accessories parts car repair tire shop tools shop phone parts e commerce',
					'theme-builder' => true,
					'woo-builder' => true,
					'off-canvas' => true,
					'price' => $is_pro_active ? 'free' : 'pro',
					'expert' => $is_expert ? 'free' : 'expert',
					'custom-types' => ['product' => 'product', 'model' => 'models', 'year' => 'years'],
					'label' => 'new',
					'priority' => 4,
				],
			],
			...
			'nature' => [
				'v1' => [
					...
					'plugins' => '{}',
					'tags' => 'free nature influencer travel content slider tourism influencers creator travel forest slider generic multipurpose national-park nature-park sanctuary wilderness hitchhiking mountain river lakes outdoors easy',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
			...
			'digital-marketing-agency' => [
				'v1' => [
					...
					'plugins' => '{}',
					'tags' => 'digital agency portfolio company corporate digital services office agency web digital marketing seo social media branding',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'pro',
				...
				'v2' => [
					...
					'plugins' => '{"woocommerce":'. $is_woo_active .'}',
					'tags' => 'digital agency portfolio company corporate digital services office agency web digital marketing seo social media branding e commerce',
					'theme-builder' => true,
					'woo-builder' => true,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'pro',
				...
				'v4' => [
					'name' => 'Digital Marketing Agency v4',
					'pages' => 'home,about,services,service-details,team,portfolio,faq,blog,single-blog,contact,',
					'plugins' => '{}',
					'tags' => 'digital agency portfolio creative branding business company corporate digital services office agency web digital marketing content seo social media branding',
					'theme-builder' => true,
					'woo-builder' => false,
			...
			'digital-seo-marketing-agency' => [
				'v1' => [
					...
					'plugins' => '{}',
					'tags' => 'digital agency portfolio company corporate digital services office agency web digital marketing seo social media branding dark black digital seo agency',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'pro',
				...
				'v2' => [
					...
					'plugins' => '{}',
					'tags' => 'digital agency portfolio company corporate digital services solutions agency web digital marketing seo social media branding dark black digital seo agency acf dynamic',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => true,
					'price' => $is_pro_active ? 'free' : 'pro',
			...
			'digital-agency-dark' => [
				'v1' => [
					...
					'plugins' => '{"media-library-assistant":'. $is_mla_active .'}',
					'tags' => 'digital agency portfolio company corporate digital services office agency web digital marketing seo social media branding dark black',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'pro',
			...
			'one-page' => [
				'v1' => [
					...
					'pages' => 'home,blog,',
					'plugins' => '{"media-library-assistant":'. $is_mla_active .'}',
					'tags' => 'digital agency portfolio company corporate digital services office agency web digital marketing seo social media branding one page onepage one pages parallax single page landing page',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'pro',
				...
				'v2' => [
					...
					'plugins' => '{"woocommerce":'. $is_woo_active .'}',
					'tags' => 'marketing insight revenue product sales business solutions one page onepage one pages single page landing page shop digital agency portfolio digital marketing agency portfolio product freelancer',
					'theme-builder' => true,
					'woo-builder' => true,
					'off-canvas' => true,
					'price' => $is_pro_active ? 'free' : 'free',
			...
			'developer-portfolio' => [
				'v1' => [
					...
					'plugins' => '{}',
					'tags' => 'web developer portfolio dev projects work resume coding code app design software free portfolio personal cv designer ux artist artwork personal resume creative freelanceer vcard it',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
			...
			'software-company' => [
				...
				'v2' => [
					...
					'pages' => 'home,plan-my-project,software-development,digital-strategy,custom-solutions,industrial,financial,digital-economy,who-we-are,our-approach,careers,resources,resource-details,',
					'plugins' => '{}',
					'tags' => 'pro saas application mobile app it services website business consulting software development enterprise solutions UI UX design testing maintenance support security data analytics web application cloud management business system digital agency portfolio business technology',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'pro',
			...
			'car-rent' => [
				'v1' => [
					...
					'price' => $is_pro_active ? 'free' : 'pro',
					'expert' => $is_expert ? 'free' : 'expert',
					'custom-types' => ['product' => 'product', 'model' => 'model'],
					'label' => 'new',
					'priority' => 4,
				],
			],
			...
			'cryptocurrency' => [
				'v1' => [
					...
					'plugins' => '{"contact-form-7":'. $is_cf7_active .'}',
					'tags' => 'cryptocurrency bitcoin ethereum etherium blockchain protection nft coin corporate crypto dark startup token digital free single page business landing page one page onepage landingpage crypto market trading trade cryptocurrency traders wallet funds portfolio money digital platform finance fintech saas bitcoin nft coin corporate financial bank funds',
					'theme-builder' => false,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
			...
			'crypto-trade' => [
				'v1' => [
					'name' => 'Landing Page - Crypto Trade V1',
					'pages' => 'home,cryptos,how-it-works,testimonials,pricing,faq,',
					'plugins' => '{}',
					'tags' => 'free single page business landing page one page onepage landingpage crypto market trading trade cryptocurrency traders wallet funds portfolio money digital platform finance fintech saas bitcoin nft coin corporate financial bank funds ai',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => true,
					'price' => $is_pro_active ? 'free' : 'free',
			...
			'lawyer' => [
				'v1' => [
					...
					'plugins' => '{}',
					'tags' => 'free free, lawyers, criminal, defence, lawyer, firm, divorce, family, law, legal, expert, court, courtroom, protection, security, settlement, appeal, fraud, civil, defense',
					'theme-builder' => false,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
				...
				'v2' => [
					'name' => 'Lawyer V2',
					'pages' => 'home,practice-area,practice-area-details,case-study,case-study-details,about-team,about,blog,single-blog,coming-soon,contact-v1,contact-v2,',
					'plugins' => '{}',
					'tags' => 'pro free, lawyers, criminal, defence, lawyer, firm, divorce, family, law, legal, expert, court, courtroom, protection, security, settlement, appeal, fraud, civil, defense',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => true,
					'price' => $is_pro_active ? 'free' : 'pro',
			...
			'digitalagency' => [
				'v1' => [
					...
					'pages' => 'home,about,services,contact,',
					'plugins' => '{"contact-form-7":'. $is_cf7_active .'}',
					'tags' => 'digital agency portfolio company corporate digital services office agency web marketing digital marketing',
					'theme-builder' => false,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
				...
				'v2' => [
					...
					'pages' => 'home,about,services,pricing,contact,',
					'plugins' => '{"contact-form-7":'. $is_cf7_active .'}',
					'tags' => 'digital agency portfolio company corporate digital services office agency web marketing slider digital marketing',
					'theme-builder' => false,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
				...
				'v3' => [
					...
					'plugins' => '{}',
					'tags' => 'free digital agency portfolio company corporate digital services office agency web marketing slider digital marketing',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
			...
			'digital-marketing' => [
				'v1' => [
					...
					'plugins' => '{}',
					'tags' => 'digital agency portfolio company corporate digital services office agency web digital marketing seo social media branding landing page onepage one page',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => true,
					'price' => $is_pro_active ? 'free' : 'free',
			...
			'architecture' => [
				'v1' => [
					'name' => 'Architecture & Interior Design v1',
				...
				'v2' => [
					'name' => 'Architecture & Interior Design v2',
			...
			'realestate' => [
				...
				'v3' => [
					...
					'price' => $is_pro_active ? 'free' : 'pro',
					'expert' => $is_expert ? 'free' : 'expert',
					'custom-types' => ['wpr-directory' => 'wpr_directory', 'wpr-property-feat' => 'wpr_property_feat', 'wpr-property-type' => 'wpr_property_type'],
					'label' => 'New',
					'priority' => 270,
				],
				'v5' => [
			...
			'real-estate-consultant' => [
				'v1' => [
					'name' => 'Real Estate Consultant V1',
					'pages' => 'home,about-me,services,reviews,contact,',
					'plugins' => '{}',
					'tags' => 'real estate agency company property rentals home estate sales developers construction agency property rentals sales property agent flat homes rent sale listing realtor broker acf dynamic houses apartment rental development land investment',
					'theme-builder' => true,
					'woo-builder' => false,
			...
			'dance-studio' => [
				'v1' => [
					...
					'plugins' => '{}',
					'tags' => 'free single-page landing page one page onepage landingpage dance studio dancing dance school ballet contempo dance club fitness salsa zumba academy courses dancer music tango academy street dance jazz hiphop education kids children',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => true,
					'price' => $is_pro_active ? 'free' : 'free',
			...
			'school' => [
				'v1' => [
					...
					'plugins' => '{}',
					'tags' => 'free school education online-education learning homework educator teacher classes dance daycare elementary school home school kindergarten nursery preschool child children babysister childcare day care preschool baby sister daycare kids toddler',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
				...
				'v2' => [
					'name' => 'Children School V2',
					'pages' => 'home,programs,about,classes,contact,',
					'plugins' => '{}',
					'tags' => 'free school education online-education learning homework educator teacher classes dance daycare elementary school home school kindergarten nursery preschool child children babysister childcare day care preschool baby sister daycare kids toddler',
					'theme-builder' => true,
					'woo-builder' => false,
			...
			'day-care-service' => [
				'v1' => [
					'name' => 'Day Care Service V1',
					'pages' => 'home,about,program,enrollment,contact,',
					'plugins' => '{}',
					'tags' => 'free day care servise children kids baby kindergarden child infant toddler preschool teacher parent learning learn school education online-education learning homework educator teacher classes dance daycare elementary home school kindergarten babysister childcare baby sister daycare',
					'theme-builder' => true,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
			...
			'wedding' => [
				'v1' => [
					...
					'plugins' => '{"contact-form-7":'. $is_cf7_active .'}',
					'tags' => ' free wedding party event slider invitation planner photography photographer pro bride groom shop woocommerce planning management photo video editing studio bouquet ceremony dress menu traditions',
					'theme-builder' => false,
					'woo-builder' => false,
					'off-canvas' => false,
					'price' => $is_pro_active ? 'free' : 'free',
				...
				'v2' => [
					'name' => 'Wedding V2',
					'pages' => 'home,about-me,about-us,our-services,our-processes,portfolio,portfolio-details,announcement,shop,product-details,cart,blog,single-blog,gallery,contact,',
					'plugins' => '{"woocommerce":'. $is_woo_active .'}',
					'tags' => 'pro wedding party event slider invitation planner photography photographer pro bride groom shop woocommerce planning management photo video editing studio bouquet ceremony dress menu traditions',
					'theme-builder' => true,
					'woo-builder' => true,
					'off-canvas' => true,
					'price' => $is_pro_active ? 'free' : 'pro',
	...
	public static function get_available_kits_for_pages() {
		...
		return [
			...
			'digital-marketing-agency-v4' => [
				'name' => 'Digital Marketing Agency v4',
				'pages' => ['home','about','services','service-details','team','portfolio','faq','blog','contact'],
			...
			'real-estate-consultant-v1' => [
				'name' => 'Real Estate Consultant V1',
				'pages' => ['home','about-me','services','reviews','contact'],
				'preview' => ['home','about-me','services','reviews','contact'],
				'price' => $is_pro_active ? 'free' : 'free',
			],
			'online-course-v1' => [
				'name' => 'Online Courses V1',
			...
			'online-course-v2' => [
				'name' => 'Online Courses V2',
				'pages' => ['home','about','courses','courses-v2','courses-with-filters','faq','blog','contact'],
				'preview' => ['home','about','courses','courses-v2','courses-with-filters','faq','blog','contact'],
				'price' => $is_pro_active ? 'free' : 'pro',
			],
			'barbershop-v1' => [
				'name' => 'Barbershop V1',
			...
			'lawyer-v2' => [
				'name' => 'Lawyer V2',
				'pages' => ['home','practice-area','practice-area-details','case-study','case-study-details','about-team','about','blog','single-blog','coming-soon','contact-v1','contact-v2'],
				'preview' => ['home','practice-area','practice-area-details','case-study','case-study-details','about-team','about','blog','single-blog','coming-soon','contact-v1','contact-v2'],
				'price' => $is_pro_active ? 'free' : 'pro',
			],
			'skincare-v1' => [
				'name' => 'Skin Care',
			...
			'software-company-v2' => [
				'name' => 'Software Company V2',
				'pages' => ['home','plan-my-project','software-development','digital-strategy','custom-solutions','industrial','financial','digital-economy','who-we-are','our-approach','careers','resources'],
				'preview' => ['home','plan-my-project','software-development','digital-strategy','custom-solutions','industrial','financial','digital-economy','who-we-are','our-approach','careers','resources'],
				'price' => $is_pro_active ? 'free' : 'pro',
			],
			'medical-v1' => [
				'name' => 'Medical',
			...
			'christmas-v1' => [
				...
				'preview' => ['home','shop','cart','blog','contact'],
				'price' => $is_pro_active ? 'free' : 'free',
			],
			'digitalagency-v1' => [
				'name' => 'Digital Agency',
			...
			'life-coaching-v1' => [
				'name' => 'Life Coaching V1',
				'pages' => ['home','about','shop','cart','podcast','podcast-details','events','blog','contact'],
				'preview' => ['home','about','shop','cart','podcast','podcast-details','events','blog','contact'],
				'price' => $is_pro_active ? 'free' : 'pro',
			],
			...
			'wedding-v2' => [
				'name' => 'Wedding V2',
				'pages' => ['home','about-me','about-us','our-services','our-processes','portfolio','portfolio-details','announcement','shop','cart','blog','gallery','contact'],
				'preview' => ['home','about-me','about-us','our-services','our-processes','portfolio','portfolio-details','announcement','shop','cart','blog','gallery','contact'],
				'price' => $is_pro_active ? 'free' : 'pro',
			],
			'school-v1' => [
				'name' => 'School - V1',
			...
			'school-v2' => [
				'name' => 'School - V2',
				'pages' => ['home','programs','about','classes','contact'],
				'preview' => ['home','programs','about','classes','contact'],
				'price' => $is_pro_active ? 'free' : 'free',
			],
			'day-care-service-v1' => [
				'name' => 'Day Care Service V1',
				'pages' => ['home','about','program','enrollment','contact'],
				'preview' => ['home','about','program','enrollment','contact'],
				'price' => $is_pro_active ? 'free' : 'free',
			],
			'portfolio-v1' => [
				'name' => 'Portfolio/CV',
